...
typedef enum {
    ...
    SIM_SCENARIO_GNSS_EXCELLENT,
    SIM_SCENARIO_GNSS_GOOD,
    SIM_SCENARIO_GNSS_FAIR,
    SIM_SCENARIO_GNSS_WEAK,
    SIM_SCENARIO_GNSS_POOR,
    SIM_SCENARIO_GNSS_STALE,
    SIM_SCENARIO_GNSS_NO_FIX,
